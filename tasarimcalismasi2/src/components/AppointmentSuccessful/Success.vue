  ...
  <div class="success-comp">
    ...
    <template v-if="success != 'Added Successfully'">
      <div class="success">
        ...
        <div class="appointment-info">
            <p class="successfull"><i>ZATEN RANDEVUNUZ VAR!</i></p>
        </div>
      </div>
      <div>
        <router-link to="/"><p class="return-homepage" style="background-color: #ff8282;">Ana Sayfa'ya Dön</p></router-link>
      </div>
    </template>
  </div>
</template>
...
export default {
  ...
  created () {
    ...
    console.log(date)
    fetch('https://cuddly-seahorse-66.loca.lt/schedule/makeschedule', {
      method: 'POST',
